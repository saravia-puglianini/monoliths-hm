...
XpraWindow.prototype.draw = function() {
	// Always discard the previous visible frame before copying the backing
	// canvas.  Chromium may otherwise keep stale pixels in a composited canvas
	// layer after a move or resize (the apparent "ghost canvas").
